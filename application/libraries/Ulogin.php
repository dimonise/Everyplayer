...
/** Список возможных провайдеров авторизации */
	public $nets=array('vkontakte'=>1,'facebook'=>2);
...
/** Вид виджета авторизации */
	...
	private $fields_opt=array('first_name','last_name','photo','email','nickname','bdate','sex','photo_big','city','country');
	private $providers_default=array('vkontakte','facebook');
	private $fields_default=array('first_name','last_name','photo','email','nickname','bdate','sex','photo_big','city','country');
	private $type='small';
...
/** Информация, предоставленная провайдером авторизации */
	...
	private $url='/auth/creat_user_soc';
