<?php if ( ! defined('BASEPATH')) exit('No direct script access allowed');
	...
	$config['grocery_crud_file_upload_allow_file_types'] 		= 'xls|xlsx|jpeg|jpg|png|mp3|ogg|wav|mp4|';
	$config['grocery_crud_file_upload_max_file_size'] 			= '150MB'; //ex. '10MB' (Mega Bytes), '1067KB' (Kilo Bytes), '5000B' (Bytes)
