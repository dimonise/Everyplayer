            ...
            <div class="col-md-3 col-sm-3 col-xs-12 menu_klan">
                <div class="row">
                    ...
                    <div class="nav_klan">
                        <ul>
                            <li>
                                <a href="/<?= $lang . '/' . $this->session->userdata('side') ?>/clan/<?= $this->uri->segment(4) ?>"><?= $this->lang->line('info_clan') ?></a>
                            </li>

                            <li>
                                <a href="/<?= $lang . '/' . $this->session->userdata('side') ?>/members/<?= $this->uri->segment(4) ?>"
                                   style="color: #ff8700;"><?= $this->lang->line('members') ?></a></li>
                            ...
                            if ($this->session->userdata('id')) {
                                ...
                                if ($rol != null) {
                                    ?>
                                    <li>
                                        <a href="/<?= $lang . '/' . $this->session->userdata('side') ?>/clan_news/<?= $this->uri->segment(4) ?>"><?= $this->lang->line('news_clan') ?></a>
                                    </li>
                                    <?php if ($rol[0]->id_roles == 1 or $rol[0]->id_roles == 2) {
                                        ?>
                                        <li>
                                            <a href="/<?= $lang . '/' . $this->session->userdata('side') ?>/recrute/<?= $this->uri->segment(4) ?>"><?= $this->lang->line('recrute_clan') ?></a>
                                        </li>
                                        <?php
                                    }
                                }
...
">
                            ...
                            <div class="group_buttons">
                                ...
                                <input type="button" class="button_players" onclick="like(<?= $user->user_id ?>)"
                                       value="<?= $this->lang->line('add_liked') ?>">
                                <input type="button" class="button_players friend2" data-friend="<?= $user->user_id ?>"
