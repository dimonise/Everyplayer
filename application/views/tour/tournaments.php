...
<div class="container">
                        ...
                        <div class="flex-container2">
                            <div class="vibor_game2">
                                <select id="name_tour" name="name_tour" onchange="name_tour()">
                                    <option value="0"><?= $this->lang->line('all_tour') ?></option>
                                    <?php
                            ...
                            <div class="vibor_game2">
                                <select id="game_tour" name="game_tour" onchange="game_tour()">
                                    <option value="0"><?= $this->lang->line('all_games') ?></option>
                                    <?php
                                    foreach ($favor_all as $gt) {
                                        ?>
                                        <option value="<?= $gt->games_id ?>"><?= $gt->games_name ?></option>
                                    <?php } ?>
                                </select>
                            </div>
                        ...
                        <div class="news1">
                            <div class="news_header">
                                ...
                                <div class="col-md-6 col-sm-12 col-xs-12 right">
                                    <div class="prem" ><p><?= $who ?></p></div>
                                    <div class="prem" ><p><?= $new->pay_tour ?></p></div>
                                    <div class="prem" ><p><?= $this->lang->line('forprem') ?> - <?= $new->pay_tour_prem ?></p></div>
                                    <div class="liked" data-info="<?= $new->tour_id ?>"><p><?= $this->lang->line('liked') ?></p></div>
    ...
    ?></div>
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12 button-center">
                                ...
                                <a href="/<?= $lang ?>/<?= $this->session->userdata('side') ?>/tournament/<?= $new->tour_id ?>/<?= $segment ?>"><input class="button_news" type="button" value="<?= $this->lang->line('more'); ?>"></a>
                            </div>
                            <hr>
                            <hr>
                        </div>
...
if(lang === 'en'){
    ...
    title = data.name_tour;
    texts = data.descr_tour;
}
