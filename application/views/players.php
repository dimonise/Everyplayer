...
//                                ?>
                ...
                foreach ($get_gamers as $user) {
                    ...
                    $games = substr($user->like_games, 0, -1);
                    $ar = explode('/', $games);
                    $res = array();
                    ...
                    <div class="col-md-9 col-sm-9 col-xs-12 players">
                        <div class="row">
                            <a href='/<?= $lang ?>/<?= $this->session->userdata('side') . "/privat_info/" . $user->user_id ?>'>
                            ...
                            <div class="info_vivod">
                                <p>
                                    <a href='/<?= $lang ?>/<?= $this->session->userdata('side') . "/privat_info/" . $user->user_id ?>'><?= $user->first_name ?></a>
                                </p>
                                <p><?= $user->username ?></p>
                            ...
                            <div class="group_buttons">
                                <input type="button" class="button_players click_mes" data-infa="<?= $user->user_id ?>"
                                       value="<?= $this->lang->line('mess') ?>">
                                <input type="button" class="button_players add_to_privat_player"
                                       value="<?= $this->lang->line('add_liked') ?>" data-info="<?= $user->user_id ?>">
